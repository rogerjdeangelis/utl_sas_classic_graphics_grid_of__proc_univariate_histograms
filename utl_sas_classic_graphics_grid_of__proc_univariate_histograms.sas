...
https://github.com/rogerjdeangelis/utl_sas_classic_graphics_grid_of__proc_univariate_histograms/blob/master/utl_sas_classic_graphics_grid_of__proc_univariate_histograms.png
